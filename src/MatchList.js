...
function MatchList() {
  ...
  const [showHistoryMatches, setShowHistoryMatches] = useState(false); // Added state for history matches
  ...
  const toggleShowHistoryMatches = () => {
    setShowHistoryMatches(!showHistoryMatches);
  };
...
//const targetDateParts = match.date.split('.');
//const targetDate = new Date(targetDateParts[2], targetDateParts[1] - 1, targetDateParts[0]); // Parse the date correctly
  ...
  return (
    <div className='App-header'>
      ...
      <label>
          <input
            type="checkbox"
            checked={showHistoryMatches}
            onChange={toggleShowHistoryMatches}
          />
          Show History 
        </label>
      </div>
        ...
        {matches
          .filter((match) => {
            ...
            return (
              ...
              (showHistoryMatches || currentDate<targetDate)
